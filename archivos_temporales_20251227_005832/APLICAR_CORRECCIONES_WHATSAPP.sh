...
if [ ! -z "$DASHBOARD_CONTAINER" ]; then
    ...
    docker cp deploy/dashboard.html $DASHBOARD_CONTAINER:/usr/share/nginx/html/dashboard.html 2>/dev/null && echo "   ✅ Copiado a /usr/share/nginx/html/" || \
    docker cp deploy/dashboard.html $DASHBOARD_CONTAINER:/app/dashboard.html 2>/dev/null && echo "   ✅ Copiado a /app/" || \
    docker cp deploy/dashboard.html $DASHBOARD_CONTAINER:/var/www/html/dashboard.html 2>/dev/null && echo "   ✅ Copiado a /var/www/html/" || \
    echo "   ⚠️ No se pudo copiar dashboard.html a ninguna ruta"
