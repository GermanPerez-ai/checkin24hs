export const COTIZADOR_BASE = import.meta.env.VITE_COTIZADOR_URL || 'https://cotizar.checkin24hs.com';
/** Número WhatsApp con código de país sin +. Por defecto 5492944411580; override con VITE_WHATSAPP_NUMBER en build. */
export const WHATSAPP_NUMBER = (import.meta.env.VITE_WHATSAPP_NUMBER || '5492944411580').trim();
export const FLOR_CHATBOT_URL = import.meta.env.VITE_FLOR_CHATBOT_URL || '';
// HTTPS sin puerto para evitar mixed content (web en HTTPS). Traefik enruta flor-api.checkin24hs.com.
export const FLOR_API_URL = (import.meta.env.VITE_FLOR_API_URL || 'https://flor-api.checkin24hs.com').trim();
