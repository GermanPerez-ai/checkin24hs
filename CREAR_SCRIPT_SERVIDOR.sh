#!/bin/bash
# Script para crear ACTUALIZAR_DASHBOARD_SERVIDOR.py en el servidor
# Ejecutar en el servidor: bash CREAR_SCRIPT_SERVIDOR.sh

cat > /root/checkin24hs/ACTUALIZAR_DASHBOARD_SERVIDOR.py << 'PYEOF'
#!/usr/bin/env python3
"""
...
chmod +x /root/checkin24hs/ACTUALIZAR_DASHBOARD_SERVIDOR.py
echo "Script creado en /root/checkin24hs/ACTUALIZAR_DASHBOARD_SERVIDOR.py"
echo "Ahora puedes ejecutar: python3 ACTUALIZAR_DASHBOARD_SERVIDOR.py"
