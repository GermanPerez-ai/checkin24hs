#!/bin/bash
# Script para crear los scripts de diagnóstico y solución de webmail en el servidor

cd /root/checkin24hs

echo "Creando scripts de diagnóstico y solución de webmail..."

python3 << 'PYEOF'
import os

# Script 1: DIAGNOSTICAR_WEBMAIL_BAD_GATEWAY.sh
script1 = '''#!/bin/bash
...
# Script 2: SOLUCIONAR_WEBMAIL_BAD_GATEWAY.sh
script2 = '''#!/bin/bash
...
with open('/root/checkin24hs/DIAGNOSTICAR_WEBMAIL_BAD_GATEWAY.sh', 'w') as f:
    f.write(script1)

with open('/root/checkin24hs/SOLUCIONAR_WEBMAIL_BAD_GATEWAY.sh', 'w') as f:
    f.write(script2)

# Hacer ejecutables
os.chmod('/root/checkin24hs/DIAGNOSTICAR_WEBMAIL_BAD_GATEWAY.sh', 0o755)
os.chmod('/root/checkin24hs/SOLUCIONAR_WEBMAIL_BAD_GATEWAY.sh', 0o755)

print("✅ Scripts creados:")
print("   - DIAGNOSTICAR_WEBMAIL_BAD_GATEWAY.sh")
print("   - SOLUCIONAR_WEBMAIL_BAD_GATEWAY.sh")
print("")
print("Ahora puedes ejecutar:")
print("   bash DIAGNOSTICAR_WEBMAIL_BAD_GATEWAY.sh")
PYEOF

chmod +x /root/checkin24hs/DIAGNOSTICAR_WEBMAIL_BAD_GATEWAY.sh
chmod +x /root/checkin24hs/SOLUCIONAR_WEBMAIL_BAD_GATEWAY.sh

echo "✅ Scripts creados y configurados"
