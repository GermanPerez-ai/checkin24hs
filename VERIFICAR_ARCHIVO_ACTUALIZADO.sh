...
echo "=========================================="
echo "VERIFICAR ARCHIVO ACTUALIZADO"
echo "=========================================="
echo ""
...
if [ "$HTTP_BUILD" = "5" ]; then
    ...
    echo "⚠️ ADVERTENCIA: HTTP muestra Build #$HTTP_BUILD (puede ser caché del navegador)"
fi
echo ""
...
echo "      Los cambios se perderán en el próximo deploy."
